  ...
  return (
    <div className="">
      ...
      <div className="px-6 pt-6 lg:px-6">
        <div>
          <nav
            className="flex h-9 px-10 items-center justify-between"
            aria-label="Global"
          >
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
             <Link href="/">
              <h1 className="h-8   text-3xl font-bold text-black">
                NFT Media
              </h1>
              </Link>
            </div>
              ...
              <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-2">
                {navigation.map((item) => (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="font-semibold px-3 py-3 text-black hover:text-black"
                  >
                    {item.name}
                  </Link>
                ))}
